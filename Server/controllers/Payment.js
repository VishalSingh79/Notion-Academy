...
//             const enrolledCourse = await Course.findOneAndUpdate({_id:courseId},{$push:{studentsEnrolled:userId}},{nre:true});
//             if(!enrolledCourse){
//                 return res.status(400).json({
//                     success:false,
...
//            const emailResponse = await mailSender(enrolledStudent.email,"Congratulations from Notion Academy","You are Onboarded into new Notion Academy Course")
